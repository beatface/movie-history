define(["dependencies", "authcall", "return-users", "createuser", "q", "loadSearch", "user-library", "delete-movie", "movie-change", "user-sign-up"], 
  function(_$_, authCall, returnusers, createuser, Q, loadSearch, usersLibrary, deleteMovie, movieChange, userSignUp) {
    $(".page").hide();
    $("#entry-screen").show();
    ...
    $('#signupButton').on("click", function() {
      ...
      userSignUp(email, password, myFirebaseRef);
    });
